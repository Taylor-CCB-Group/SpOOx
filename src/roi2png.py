...
def roi2images(src_dir,dest_dir,output_tsv):
    ...
    for file in onlyfiles:    
        ...
        # make a tsv file (useful for Zegami but not needed generally)
        tab = "\t"
